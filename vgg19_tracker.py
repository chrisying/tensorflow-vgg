...
class Vgg19:
    ...
    def build(self, key_img, search_img, ground_truth):
        ...
        self.corr1, self.b1 = self.cross_corr_layer(self.key_pool1, self.search_pool1, "corr1")
        self.corr2, self.b2 = self.cross_corr_layer(self.key_pool2, self.search_pool2, "corr2")
        self.corr3, self.b3 = self.cross_corr_layer(self.key_pool3, self.search_pool3, "corr3")
        self.corr4, self.b4 = self.cross_corr_layer(self.key_pool4, self.search_pool4, "corr4")
        self.corr5, self.b5 = self.cross_corr_layer(self.key_pool5, self.search_pool5, "corr5")
