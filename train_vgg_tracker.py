...
search = np.array(Image.open(os.path.join(PROCESSED_DIR, 'fish1', 'key-00000001', 'search-00000002.png'))).reshape([1, SEARCH_FRAME_SIZE, SEARCH_FRAME_SIZE, 3])
...
with tf.device('/cpu:0'):
    ...
    vgg.build(key_image, search_img)
